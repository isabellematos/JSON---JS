...
const getLivro = function(palavra){
        ...
        if(palavra != '') {
           // percorrer o array de livros para validar o nome
            livros.forEach (item => {
               ...
               //Percorre o array da chave de livros dentro do nome que foi encontrado
                        total++
                        totalLivros.push({nome:itembooks.title, descricao:itembooks.subtitle, preco:itembooks.price, imagem:itembooks.image })
                        erro = false
               }
            });
         });
